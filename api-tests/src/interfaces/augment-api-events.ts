...
import type { CurioDevnetRuntimeProxyType, FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletMultisigTimepoint, PalletWhitelistInvestor, PrimitivesCurrencyCurrencyId, PrimitivesTradingPair, SpRuntimeDispatchError, SpWeightsWeightV2Weight, XcmV1MultiLocation, XcmV2Response, XcmV2TraitsError, XcmV2TraitsOutcome, XcmV2Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    common: {
       ...
       **/
      AdminToggled: AugmentedEvent<ApiType, [AccountId32, bool]>;
      /**
    ...
    currencies: {
       ...
       * Dust swept.
       **/
      DustSwept: AugmentedEvent<ApiType, [currencyId: PrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128], { currencyId: PrimitivesCurrencyCurrencyId, who: AccountId32, amount: u128 }>;
      /**
       * Currency transfer success.
       **/
      Transferred: AugmentedEvent<ApiType, [currencyId: PrimitivesCurrencyCurrencyId, from: AccountId32, to: AccountId32, amount: u128], { currencyId: PrimitivesCurrencyCurrencyId, from: AccountId32, to: AccountId32, amount: u128 }>;
      /**
    ...
    dex: {
       ...
       **/
      AddLiquidity: AugmentedEvent<ApiType, [who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, pool0: u128, currency1: PrimitivesCurrencyCurrencyId, pool1: u128, shareIncrement: u128], { who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, pool0: u128, currency1: PrimitivesCurrencyCurrencyId, pool1: u128, shareIncrement: u128 }>;
      /**
       * add provision success
       **/
      AddProvision: AugmentedEvent<ApiType, [who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, contribution0: u128, currency1: PrimitivesCurrencyCurrencyId, contribution1: u128], { who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, contribution0: u128, currency1: PrimitivesCurrencyCurrencyId, contribution1: u128 }>;
      /**
       * Disable trading pair.
       **/
      DisableTradingPair: AugmentedEvent<ApiType, [tradingPair: PrimitivesTradingPair], { tradingPair: PrimitivesTradingPair }>;
      /**
       * Enable trading pair.
       **/
      EnableTradingPair: AugmentedEvent<ApiType, [tradingPair: PrimitivesTradingPair], { tradingPair: PrimitivesTradingPair }>;
      /**
       * List provisioning trading pair.
       **/
      ListProvisioning: AugmentedEvent<ApiType, [tradingPair: PrimitivesTradingPair], { tradingPair: PrimitivesTradingPair }>;
      /**
       * Provisioning trading pair aborted.
       **/
      ProvisioningAborted: AugmentedEvent<ApiType, [tradingPair: PrimitivesTradingPair, accumulatedProvision0: u128, accumulatedProvision1: u128], { tradingPair: PrimitivesTradingPair, accumulatedProvision0: u128, accumulatedProvision1: u128 }>;
      /**
       * Provisioning trading pair convert to Enabled.
       **/
      ProvisioningToEnabled: AugmentedEvent<ApiType, [tradingPair: PrimitivesTradingPair, pool0: u128, pool1: u128, shareAmount: u128], { tradingPair: PrimitivesTradingPair, pool0: u128, pool1: u128, shareAmount: u128 }>;
      /**
       * refund provision success
       **/
      RefundProvision: AugmentedEvent<ApiType, [who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, contribution0: u128, currency1: PrimitivesCurrencyCurrencyId, contribution1: u128], { who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, contribution0: u128, currency1: PrimitivesCurrencyCurrencyId, contribution1: u128 }>;
      /**
       * Remove liquidity from the trading pool success.
       **/
      RemoveLiquidity: AugmentedEvent<ApiType, [who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, pool0: u128, currency1: PrimitivesCurrencyCurrencyId, pool1: u128, shareDecrement: u128], { who: AccountId32, currency0: PrimitivesCurrencyCurrencyId, pool0: u128, currency1: PrimitivesCurrencyCurrencyId, pool1: u128, shareDecrement: u128 }>;
      /**
       * Use supply currency to swap target currency.
       **/
      Swap: AugmentedEvent<ApiType, [trader: AccountId32, path: Vec<PrimitivesCurrencyCurrencyId>, liquidityChanges: Vec<u128>], { trader: AccountId32, path: Vec<PrimitivesCurrencyCurrencyId>, liquidityChanges: Vec<u128> }>;
    };
    dmpQueue: {
      /**
       * Downward message executed with the given outcome.
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: CurioDevnetRuntimeProxyType, delay: u64], { delegator: AccountId32, delegatee: AccountId32, proxyType: CurioDevnetRuntimeProxyType, delay: u64 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: CurioDevnetRuntimeProxyType, delay: u64], { delegator: AccountId32, delegatee: AccountId32, proxyType: CurioDevnetRuntimeProxyType, delay: u64 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: CurioDevnetRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: CurioDevnetRuntimeProxyType, disambiguationIndex: u16 }>;
    };
    scheduler: {
      /**
    ...
    whitelist: {
       ...
       * New `Admin` added
       **/
      AddAdmin: AugmentedEvent<ApiType, [newAdmin: AccountId32], { newAdmin: AccountId32 }>;
      /**
       * New `Investor` added
       **/
      AddInvestor: AugmentedEvent<ApiType, [who: AccountId32, investorKey: U8aFixed, investor: PalletWhitelistInvestor], { who: AccountId32, investorKey: U8aFixed, investor: PalletWhitelistInvestor }>;
      /**
       * New `Manager` added
       **/
      AddManager: AugmentedEvent<ApiType, [who: AccountId32, newManager: AccountId32], { who: AccountId32, newManager: AccountId32 }>;
      /**
       * 'Investor' account changed
       **/
      InvestorAccountChanged: AugmentedEvent<ApiType, [who: AccountId32, oldAccount: AccountId32, newAccount: AccountId32], { who: AccountId32, oldAccount: AccountId32, newAccount: AccountId32 }>;
      /**
       * 'Investor' active status changed
       **/
      InvestorStatusSet: AugmentedEvent<ApiType, [who: AccountId32, investor: AccountId32, isActive: bool], { who: AccountId32, investor: AccountId32, isActive: bool }>;
      /**
       * `Admin` removed
       **/
      RemoveAdmin: AugmentedEvent<ApiType, [admin: AccountId32], { admin: AccountId32 }>;
      /**
       * `Manager` removed
       **/
      RemoveManager: AugmentedEvent<ApiType, [who: AccountId32, manager: AccountId32], { who: AccountId32, manager: AccountId32 }>;
    };
    xcmpQueue: {
      /**
       * Bad XCM format used.
