...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(990_114, 0)
			// Standard Error: 1_215
			.saturating_add(Weight::from_parts(946_222, 0).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(6_032_000, 0)
			...
			.saturating_add(Weight::from_parts(743_919, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	/// The range of component `p` is `[0, 1000]`.
	fn kill_prefix(p: u32, ) -> Weight {
		// Minimum execution time: 8_346 nanoseconds.
		Weight::from_parts(3_491_906, 0)
			// Standard Error: 2_044
			.saturating_add(Weight::from_parts(1_346_801, 0).saturating_mul(p.into()))
