...
use sp_runtime::{
    ...
    traits::{
        AccountIdLookup, BlakeTwo256, Block as BlockT, ConvertInto, SaturatedConversion,
        StaticLookup,
    },
...
use frame_support::{
    ...
    log, parameter_types,
    traits::{
        EitherOfDiverse, EqualPrivilegeOnly, InstanceFilter, LockIdentifier,
...
// Curio
pub use primitives::time::mainnet::*;
pub use primitives::*;
...
mod currency_id;
mod dex;
pub use crate::currency_id::{CurrencyId, TokenSymbol, CGT};
...
pub mod node_imports {
	...
	pub use parachain_staking::InflationInfo;
	pub use primitives::time::mainnet::BLOCKS_PER_YEAR;
    #[cfg(feature = "try-runtime")]
	pub use primitives::time::mainnet::MILLISECS_PER_BLOCK;
}
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("curio-mainnet"),
    impl_name: create_runtime_str!("curio-mainnet"),
    authoring_version: 1,
    spec_version: 13,
    impl_version: 0,
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        // Curio
        Dex: pallet_dex::{Pallet, Call, Storage, Config<T>, Event<T>} = 71,
        Currencies: pallet_currencies::{Pallet, Call, Storage, Event<T>} = 72,
        Tokens: orml_tokens::{Pallet, Storage, Call, Config<T>, Event<T>} = 73,
        Bridge: pallet_bridge::{Pallet, Storage, Call, Config<T>, Event<T>} = 74,

        // Acala
        Pausing: module_transaction_pause::{Pallet, Storage, Call, Event<T>} = 80,
