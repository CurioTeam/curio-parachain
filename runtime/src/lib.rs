...
use frame_support::{
	...
	traits::{
		ConstU32, ConstU128, Contains, ContainsLengthBound, Currency, EitherOfDiverse, Everything, EqualPrivilegeOnly,
		InstanceFilter, LockIdentifier, OnUnbalanced, SortedMembers, U128CurrencyToVote},
	weights::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("curio-parachain"),
	impl_name: create_runtime_str!("curio-parachain"),
	authoring_version: 1,
	spec_version: 12,
	impl_version: 0,
...
parameter_types! {
	...
	pub const MinCollatorStk: u128 = 25_000 * DOLLARS;
}
...
impl pallet_parachain_staking::Config for Runtime {
	...
	type MinCandidateStk = ConstU128<{ 500 * DOLLARS }>;
	/// Minimum delegation amount after initial
	type MinDelegation = ConstU128<{ 50 * DOLLARS }>;
	/// Minimum initial stake required to be reserved to be a delegator
	type MinDelegatorStk = ConstU128<{ 50 * DOLLARS }>;
...
parameter_types! {
	...
	pub const BountyUpdatePeriod: BlockNumber = 6 * DAYS;
...
impl pallet_tips::Config for Runtime {
	...
	type WeightInfo = pallet_tips::weights::SubstrateWeight<Self>;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		//Contracts: pallet_contracts::{Pallet, Call, Storage, Event<T>} = 69,
		//ImOnline: pallet_im_online::{Pallet, Call, Storage, Event<T>, ValidateUnsigned, Config<T>} = 70,
        //AuthorityDiscovery: pallet_authority_discovery::{Pallet, Config} = 71,
        //Offences: pallet_offences::{Pallet, Storage, Event} = 72,
        //Historical: pallet_session_historical::{Pallet} = 73,
        ...
        //Recovery: pallet_recovery::{Pallet, Call, Storage, Event<T>} = 77,
