...
parameter_types! {
	pub static CGTETHPair: TradingPair<CurrencyId> = <TradingPair<CurrencyId>>::from_currency_ids(CGT, ETH).unwrap();
	pub static CGTDOTPair: TradingPair<CurrencyId> = <TradingPair<CurrencyId>>::from_currency_ids(CGT, DOT).unwrap();
	pub static DOTETHPair: TradingPair<CurrencyId> = <TradingPair<CurrencyId>>::from_currency_ids(DOT, ETH).unwrap();
}
...
impl Happened<(TradingPair<CurrencyId>, Balance, Balance)> for MockOnLiquidityPoolUpdated {
	fn happened(info: &(TradingPair<CurrencyId>, Balance, Balance)) {
...
pub struct ExtBuilder {
	...
	initial_listing_trading_pairs: Vec<(TradingPair<CurrencyId>, (Balance, Balance), (Balance, Balance), BlockNumber)>,
	initial_enabled_trading_pairs: Vec<TradingPair<CurrencyId>>,
	initial_added_liquidity_pools: Vec<(AccountId, Vec<(TradingPair<CurrencyId>, (Balance, Balance))>)>,
}
